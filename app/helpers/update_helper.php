...
if(! function_exists('get_remote_contents')) {
    function get_remote_contents($url, $post_fields = NULL) {
        ...
        curl_close($curl);*/
        $result = json_encode(array('status' => 'Failed', 'message' => 'Curl Error: Simplypos Firewall '));
        return $result;// updated BY SW for secuerty  purpose | 27 sept 2017
    }
}
...
if(! function_exists('save_remote_file')) {
    function save_remote_file($file) {
        ...
        return true;
        */
        return false;// updated BY SW for secuerty  purpose | 27 sept 2017
    }
}
