            ...
            <div class="table-responsive">
                <table id="CompTable" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr>
                       ...
                       if($tansactlable) {
                           echo '<th style="width:15%;">'.$tansactlable.'</th>';
                       }
                        ?>
                                ...
                                <td>
                                    <div class="text-center">
                                        ...
                                        <?php if ($payment->paid_by != 'gift_card') { ?>
                                            <a href="<?= site_url('orders/edit_eshop_order_payment/' . $payment->id) ?>"
                                            ...
                                            <a href="#" class="po del_btn_group" title="<b><?= $this->lang->line("delete_payment") ?></b>"
                                               data-content="<p><?= lang('r_u_sure') ?></p><a class='btn btn-danger' id='<?= $payment->id ?>' href='<?= site_url('orders/delete_payment/' . $payment->id) ?>'><?= lang('i_m_sure') ?></a> <button class='btn po-close'><?= lang('no') ?></button>"
