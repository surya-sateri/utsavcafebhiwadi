                        ...
                        <table style="width:100%; font-size: 13px;">
                            <tr>
                                <td class="text-left" style="width:50%;font-size: 13px; padding-left: 15px; vertical-align: top; ">
                                    <?php
                                    echo '<b>' . lang("Billing details ") . "</b><br/> <b>Name</b> : " . $billerDetails[0]['billing_name'] . '<br/>';
                                ...
                                <td class="text-left" style="width:50%;font-size: 13px; padding-left: 15px; vertical-align: top; ">
                                    ...
                                    <br/><span><b>Name</b> : <?= $billerDetails[0]['shipping_name']; ?></span>
                                    <address>
                                        ...
                                        <?php
                                        if ($billerDetails) {
                                            echo $billerDetails[0]['shipping_method_name'] . '&nbsp;';
                                        }if ($inv->deliver_later) {
                                            echo ' <b>Date</b> : ' . date('d-m-Y', strtotime($inv->deliver_later)) . '&nbsp;';
                                        }if ($inv->time_slotes) {
                                            echo '<b>Time</b> : ' . $inv->time_slotes;
                                        }
                                        ?>    
