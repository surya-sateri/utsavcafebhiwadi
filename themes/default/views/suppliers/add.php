    ...
    <div class="modal-content">
        ...
        data-bv-onerror="onFieldError" data-bv-onsuccess="onFieldSuccess" data-bv-onstatus="onFieldStatus"/>
			...
			?>
				...
				echo form_dropdown('state', $st, (isset($_POST['state']) ? $_POST['state'] : $biller->state), 'id="state" data-placeholder="' . lang("select") . ' ' . lang("state") . '" class="form-control input-tip select" style="width:100%; height:30px;"');
			?>
                    ...
                    <div class="form-group">
                        ...
                        <?php echo form_input('postal_code', '', 'class="form-control" id="postal_code" onkeypress="return IsNumeric1(event)" 
   ondrop="return false"'); ?>
