            ...
            <div class="col-lg-12">
                ...
                <fieldset class="scheduler-border">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <?= form_input('coupon_code', set_value('coupon_code'), 'placeholder="Coupon Code" class="form-control" required = "required"  id="coupon_code" style="text-transform:uppercase"'); ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <?= form_input('coupon_descripion', set_value('coupon_descripion'), 'placeholder="Coupon Descripion" class="form-control" required = "required"  id="coupon_descripion" style="text-transform:uppercase"'); ?>
                    ...
                    <div class="form-group row "  >
                        ...
                        <div class="col-sm-8">
                            <input type="text" value="<?php echo set_value('discount'); ?>" maxlength="5" name='discount' value="<?= (isset($_POST['discount'])) ? $_POST['discount'] : '' ?>" placeholder="Discount"  autocomplete="off" class="form-control " required="required" id="discount_rate" />
                    ...
                    <div class="form-group row "  >
                        ...
                        <div class="col-sm-8">
                            <input type="text" value="<?php echo set_value('max_coupons'); ?>" maxlength="5" name='max_coupons' value="<?= (isset($_POST['max_coupons'])) ? $_POST['max_coupons'] : '' ?>" placeholder="Max Coupons"  autocomplete="off" class="form-control "  id="max_coupons" onkeypress="return event.charCode >= 48 && event.charCode <= 57" />
