...
<div class="box">
    ...
    <div class="box-content">
            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                   ...
                   <fieldset class="scheduler-border">
                            ...
                            <div class="col-md-4">
                                    <div class="form-group">
                                            <label class="control-label" for="invoice_view_purchase"><?= lang("invoice_view_purchase"); ?></label>
                                            <div class="controls">
                                                    <?php
                                                    $opt_inv = array(1 => lang('tax_invoice'), 0 => lang('standard'));
                            ...
                            <div class="col-md-4">
                                    <div class="form-group">
                                            <label class="control-label" for="tax_classification_view__purchase"><?= lang("tax_classification_view__purchase"); ?></label>
                                            <div class="controls">
                                                    <?php
                                                    $opt_inv = array(1 => lang('Yes'), 0 => lang('No'));
		...
		<fieldset class="scheduler-border">
			<legend class="scheduler-border"><?= lang('Request Notification') ?></legend>
			<div class="col-md-4">
				<div class="form-group">
					<div class="controls">
					<input type="checkbox" value="1" class="checkbox" name="auto_acceptance" <?php if($Settings->auto_acceptance == 1){ echo "checked";} ?>/>
					<label> Auto Acceptance</label>
					</div>
				</div>
			</div>
		</fieldset>
