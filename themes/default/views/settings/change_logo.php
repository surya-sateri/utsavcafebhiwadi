...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <?= lang("Webshop Logo", "Webshop Logo") ?>
                <input id="webshop_logo" type="file" data-browse-label="<?= lang('browse'); ?>" name="webshop_logo" data-show-upload="false" data-show-preview="false" class="form-control file">
            </div>
            
            <div class="form-group">
                <?= lang("Webshop Favicon", "Webshop Favicon") ?>
                <input id="webshop_favicon" type="file" data-browse-label="<?= lang('browse'); ?>" name="webshop_favicon" data-show-upload="false" data-show-preview="false" class="form-control file">
            </div>
        </div>
