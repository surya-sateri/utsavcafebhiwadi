...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <label for="discount"><?php echo $this->lang->line("Apply As Discount *"); ?></label>

               
                <input type="checkbox" checked="<?= (( $customer_group->apply_as_discount) ?'true' :'false') ?>" name="apply_as_discount" value="1" class="form-control"> 
