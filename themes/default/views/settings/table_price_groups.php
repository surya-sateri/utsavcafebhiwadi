...
<script>
    $(document).ready(function () {
        $('#CGData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('system_settings/tablegetPriceGroups') ?>',
...
<div class="box">
    <div class="box-header">
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <a title="<?= lang('add_price_group') ?>" class="tip" href="<?php echo site_url('system_settings/add_price_group?type=table'); ?>" data-toggle="modal" data-target="#myModal">
