                ...
                <table  id="depositTable" style="width: 100%;border-collapse: collapse;text-align: left;" > 
                    <tbody>
                       <tr>
                        ...
                        <td><?= $this->sma->formatMoney(($customerData->deposit_amount?$customerData->deposit_amount:"0")) ?></td>
                    ...
                    <tr>
                        ...
                        <td > <?= $this->sma->formatMoney(($customerData->deposit_amount?$customerData->deposit_amount + $deposit_data['amount']: $customerData->deposit_amount + $deposit_data['amount']) ) ?> </td>
                    </tr>
                    <tr>
                        <td > Paid By </td>
