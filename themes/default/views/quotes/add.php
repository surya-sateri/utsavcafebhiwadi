...
<script type="text/javascript">
    var count = 1, an = 1, product_variant = 0, DT = <?= $Settings->default_tax_rate ?>, allow_discount = <?= ($Owner || $Admin || $this->session->userdata('allow_discount')) ? 1 : 0; ?>,
        product_tax = 0, invoice_tax = 0, total_discount = 0, total = 0,net_price=0, shipping = 0,
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group"id="customer_red">
                                                ...
                                                <div class="input-group-addon no-print" style="padding: 2px 8px; border-left: 0;">
                                                    <a href="#" id="toogle-customer" class="external edit-customers" data-target="#myModal" data-toggle="modal">
                                            ...
                                            <span id="error" style="color:#a94442;font-size:11px; display: none">Please enter/select a value</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
	...
	var cust_field = $("#qucustomer").val();
		...
		$("#customer_red").css({"border":"1.5px solid #a94442"});
		
		$("#lable_red").css({"color":"#a94442"});
		...
		$("#lable_red").css({"color":"#2b542c"});
		$("#customer_red").css({"border":"1.5px solid #2b542c"});
