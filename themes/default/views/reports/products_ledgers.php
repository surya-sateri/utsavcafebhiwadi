...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-barcode"></i><?= lang('products_ledgers'); ?> <?php
            if($this->input->post('start_date'))
            {
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                <div id="form">
                    <?php echo form_open("reports/products_ledgers"); ?>
                    <div class="row">
                        <div class="col-sm-4">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=site_url('reports/getProductsLedgers?v=1&export=pdf' . $v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('reports/getProductsLedgers?v=1&export=xls' . $v)?>";
            return false;
        });
        $('#image').click(function (event) {
            event.preventDefault();
			window.location.href = "<?=site_url('reports/getProductsLedgers?v=1&export=img' . $v)?>";
            /*html2canvas($('.box'), {
    ...
    function loadReport(page){
        ...
        $.ajax({
            ...
            data:'action=ProductsLedgers&page='+page+'<?=$v?>',
            beforeSend: function(){
