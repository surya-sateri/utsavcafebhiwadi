                            ...
                            <?php
                                if($action_status === TRUE) {
                                    ...
                                    ?>                                
                                        ...
                                        <p class="text-center text-danger">For Mobile Verification : <button type="submit">Click here to get verification OTP</button> (Optional)</p>
                                        <p class="text-center"><a href="<?=base_url('shop/login')?>" class="btn btn-info">Skip & Login</a></p>
                                    <?php 
                                        echo  form_close(); 
                                    }//end if 
                                    else
