                        ...
                        <div class="col-md-6 col-md-offset-3">                            
                            <div class="suc-ord">
                                ...
                                if ($action_status == FALSE) {
                                    ...
                                    echo '<h2>Please enter Verification code sent to your '.$_SESSION['guestlogininfo']['phone'].'.</h2>';


                                    $attrib = array('role' => 'form', 'id' => 'verify-mobile');
                                    echo form_open("shop/getotp", $attrib);
                                    ?>
                                    ...
                                    <div class="row">                                        
                                        ...
                                        <div class="col-md-4"><br/><br/>
                                            <a href="<?= base_url("shop/resendquestopt") ?>">Resend Code</a></div>
                                        </div>
                                        <div class="row"> 
