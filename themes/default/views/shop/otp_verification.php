                        ...
                        <div class="col-md-6 col-md-offset-3">                            
                            <div class="suc-ord">
                                    ...
                                    if($action_status == FALSE) { 
                                        ...
                                        echo '<h2>Please enter Verification code sent on your Mobile no: '.$_GET['mobileno'].' </h2>';
                                        echo form_open("shop/otp_varification");  
                                    ?>
                            
                                    <div class="row">                                        
                                        <div class="col-md-6"> 
                                            <label for="data-mask">Enter 6 digit verification code.</label>
                                            <input type="hidden" name="otp_id" value="<?= (($_GET['code'])?$_GET['code']:$_POST['otp_id']) ?>" />
                                        ...
                                        <div class="col-md-4"><br/><br/><a href="<?= base_url("shop/resend_otp/".(($_GET['code'])?$_GET['code']:$_POST['otp_id']))?>">Resend Code</a></div>
                                    </div>
                                    <div class="row"> 
