...
<div class="landing-img-bg"><img src="<?= $assets?>/shop/img/welcom_comm.jpg" class="img-responsive well-background-image"></div>
<div class="row">
    <div class="col-sm-8">
            <div class="left-content">
                    <div class="left-section-heading">
                            A Shop your family can trust
                    </div>
                    <div class="left-section-content1">
                            Online shop have significantly increased due to growing E-commerce. An online E-Shop is a Shop that operate over the Internet and sends the orders to customers through the mail or shipping companies.
                    </div>
                    <div class="left-section-content2">
                            Where the old fashioned, neighborhood retailer shop of yesterday meets the high tech
                    </div>
