...
<script>
    $(document).ready(function () {
        $('#OrderTable').dataTable({
            ...
            'sAjaxSource': '<?= site_url('eshop_admin/getOrders') ?>',
            ...
            "aoColumns": [{"mRender": fld},  null, null, null ,null, null , {"bSortable": false}]
...
<?= form_open('eshop_admin/category_actions', 'id="action-form"') ?>
<div class="box">
