...
<script>
    $(document).ready(function () {
        var oTable = $('#TOData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('transfers/getTransfersRequests').$v  ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-star-o"></i>Products Transfer Request</h2>
...
<!--                        <li class="divider"></li>
                        <li>
                            <a href="#" class="bpo" title="<b><?= $this->lang->line("delete_requests") ?></b>"
                             data-content="<p><?= lang('r_u_sure') ?></p><button type='button' class='btn btn-danger' id='delete' data-action='delete'><?= lang('i_m_sure') ?></a> <button class='btn bpo-close'><?= lang('no') ?></button>"
                             data-html="true" data-placement="left">
                             <i class="fa fa-trash-o"></i> <?= lang('delete_requests') ?>
                         </a>
                     </li>-->
                 </ul>
             </li>
