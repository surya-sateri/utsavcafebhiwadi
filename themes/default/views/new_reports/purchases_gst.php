               ...
               // console.log(id);
                 var url = '<?= site_url("reports_new/getPurchaseItemsGst/") ?>?id='+id;
                    ...
                    console.log(result);
                        ...
                        nCells[14].innerHTML =  result['CGST'];
                        nCells[15].innerHTML =  result['SGST'];
                        nCells[16].innerHTML =  result['IGST'];
                        nCells[17].innerHTML =  (result['VAT'])?'Rs. '+result['VAT'] :'Rs.0.00';
                        nCells[18].innerHTML =  (result['CESS'])?'Rs. '+result['CESS'] :'Rs.0.00';
                    }, error:function(){
