...
<html>
<head>
    <title>Ecommerce Website Not Found</title>
...
<body style="background: url('<?=base_url("assets/uploads/eshop_user/page_404.png")?>') 50% 50%!important;">
    <div class="wrap" style="padding-bottom:150px;">
        <div class="main">
            <h1 class="big"></h1>
            <h1 style="color:#000000;">Ecommerce Website<br/> Not In Service</h1>
            <div class=""><p><b>We are sorry, the service you have requested is not active.</b></p></div>            
        </div>
    </div>
</body>
</html>