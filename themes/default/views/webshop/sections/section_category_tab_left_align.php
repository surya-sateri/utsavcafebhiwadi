<?php
$sectionKey = md5('section_category_tab_left_align');
$sectionData = $section_category_tab_left_align;
    ...
    <div class="section-products-carousel-tabs-wrap">
        <header class="section-header">
            ...
            <h2 class="section-title">
                ...
                <?= $is_admin_login ? '<small title="Section Settings"><a href="'.base_url("webshop_settings/elements/section_category_tab_left_align").'" target="new" ><i class="fa fa-cog text-info"></i></a></small>' : ''; ?>
            </h2>
