...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?= lang('Edit_Credit_Note'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
        echo form_open("sales/edit_credit_note/" . $gift_card->id, $attrib); ?>
        ...
        <div class="modal-footer">
            <?php echo form_submit('edit_credit_note', lang('Edit_Credit_Note'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
