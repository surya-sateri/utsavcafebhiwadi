                ...
                <div id="receipt-data" style="font-size: <?php echo $font_size; ?>pt !important">
                    ...
                    <div class="text-center">
                        ...
                        if ($Settings->invoice_view == 1) {
                            ...
                            <div class="col-sm-12 text-center">
                                <h5 style="font-weight:bold; margin: 0px;"><?php // $this->Settings->order_receipt_label ? $this->Settings->order_receipt_label : 'Delivery Challan Order' ?> Delivery Challan Order </h5>
                            </div>
                    <hr/>
                            <?php
                        }
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="pull-left"><b><?php // $this->Settings->order_receipt_label ? $this->Settings->order_receipt_label : 'Challan ' ?>Challan  No. </b>: <?= $inv->invoice_no; ?>
