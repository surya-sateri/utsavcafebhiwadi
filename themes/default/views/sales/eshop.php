...
<script>
<?php if($status!=''){ ?>
         UrlPost = '<?= site_url('sales/getEshopSales'.($warehouse_id ? '/'.$warehouse_id : '').'?status='.$status); ?>';
		<?php }else{ ?>
		 UrlPost = '<?= site_url('sales/getEshopSales'.($warehouse_id ? '/'.$warehouse_id : '')) ?>';
		<?php } ?>
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-heart"></i>Eshop <?=lang('sales') . ' (' . ($warehouse_id ? $warehouse->name : lang('all_warehouses')) . ')';?>
        </h2>
                        ...
                        <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                            ...
                            <?php
                            	foreach ($warehouses as $warehouse) {
                            	        echo '<li><a href="' . site_url('sales/eshop_sales/' . $warehouse->id) . '"><i class="fa fa-building"></i>' . $warehouse->name . '</a></li>';
                            	    }
                                ?>
                        </ul>
                    </li>
