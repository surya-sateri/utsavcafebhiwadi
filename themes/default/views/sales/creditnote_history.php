...
<h4 class="modal-title" id="myModalLabel">Credit Note History</h4>
        </div>
        <div class="modal-body">
            <div class="table-responsive">
                <table id="CompTable" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tbody>
                    <?php
                    //print_r($historycreditnote);
                    if (!empty($historycreditnote)) {
                        foreach ($historycreditnote as $histgiftcard) { ?>
                            <tr >
