        ...
        if (localStorage.getItem('reitems')) {
            ...
            $.each(reitems, function () {
              ...
              $.each(item.options, function () {
                    ...
                    if (jQuery.type(item.row.option) == 'string') {
                        ...
                        $.each(optionArr, function (k, opt) {
                            ...
                            if (this_options.id == opt) {     
                                ...
                                if (this_options.price != 0 && this_options.price != '' && this_options.price != null) {            //console.log(this_options.id +'=='+ opt+'/'+unit_price+' '+this_options.price);                       item_price = formatDecimal(parseFloat(unit_price) + parseFloat(this_options.price),6);
                                    unit_price = item_price;
                ...
                tr_html += '<td class="text-center"><span>' + formatDecimal(item_oqty) + '</span></td>'; //formatDecimal(item_qty) 
                ...
                tr_html +='<td class="text-right">'+formatMoney(parseFloat(unit_price)  * parseFloat(item_qty) )+'</td>';
