...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?= lang('Add_Credit_Note'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
        echo form_open("sales/add_credit_note", $attrib); ?>
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <?php echo form_input('card_no', '', 'class="form-control" id="card_no" required="required" maxlength="16"'); ?>
            ...
            <div id="customer-con">
                <div class="form-group">
                    ...
                    <?php echo form_input('customer', '', 'class="form-control" id="customer" required="required"'); ?>
                </div>
            ...
            <div class="form-group">
                ...
                <?php echo form_input('expiry', $this->sma->hrsd(date("Y-m-d", strtotime("+2 year"))), 'class="form-control date" id="expiry" required="required"'); ?>
            </div>

        </div>
        <div class="modal-footer">
            <?php echo form_submit('add_credit_note', lang('Add_Credit_Note'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
