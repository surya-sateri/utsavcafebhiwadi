                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="text"  required="required" class="form-control" value="<?=$postdata['zip_code']?>" name="zip_code" value="<?php echo set_value('zip_code'); ?>"  placeholder="Zip code " id="zip_code" >
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="text" class="form-control" required="required" value="<?=$postdata['notification_emails']?>" name="notification_emails" placeholder="Notification Emails" id="notifi_email" >
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="controls"> 
                                <input type="text" inputmode="numeric" oninput="formatNumber(event)" required="required" class="form-control" value="<?=$postdata['notification_phones']?>" name="notification_phones" placeholder="Notification Mobile No" id="notifi_phone" />
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="text" maxlength="4" value="<?= $postdata['min_order_value'] ?>" min="0" name="min_order_value" class="form-control" id="min_order_value"  onkeypress="return event.charCode >= 48 && event.charCode <= 57" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls"> 
                                <select class="form-control" multiple="multiple" name="excluded_platforms[]"   id="excluded_platforms" >
                                    <?php foreach(UrbanpiperExcludedPlatform() as $explatform){ ?>
                                        <option value="<?= $explatform ?>"> <?= ucfirst($explatform)  ?> </option>
                                    <?php } ?>
                                </select>    
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls"> 
                                <select class="form-control" multiple="multiple" name="included_platforms[] "   id="included_platforms " >
                                    <?php foreach(UrbanpiperIncludedPlatform() as $inplatform){ ?>
                                        <option value="<?= $inplatform ?>"> <?= ucfirst($inplatform)  ?> </option>
                                    <?php } ?>
                                </select>    
                            </div>
                        </div>
