    ...
    $(document).ready(function () {
        ...
        ////////////////////////////////////////////////////////////
         var oTable = $('#POSData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('urban_piper/getSales'.($warehouse_id ? '/'.str_replace(",","_",$warehouse_id) : '')) ?>',
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, {"mRender": fld}, null, null, null, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat},{"mRender": row_status}, {"mRender": row_status}, {"mRender": row_status}, {"bSortable": false}],
            ...
            {column_number: 10, filter_default_label: "[<?=lang('Delivery');?>]", filter_type: "text", data: []},
        ], "footer"); 
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-barcode"></i><?= lang('UrbanPiper') . ' (' . ($warehouse_id ? (isset($warehouse->name)?$warehouse->name:lang('all_warehouses')): lang('all_warehouses')) . ')'; ?>
        </h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
