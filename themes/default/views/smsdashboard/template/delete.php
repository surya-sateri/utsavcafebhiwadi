<?php defined('BASEPATH') OR exit('No direct script access allowed');
  $action = site_url('smsdashboard/templateDelete').'?template_id='.$template->id;
...
<input type="hidden" name="template_action" value="del"> 
<div class="row">
    <div class="col-md-12">
    ...
    <div class="col-md-12" class="template_member">
    ...
    <div class="col-md-12">
        <div class="form-group" >
           <?php echo form_submit('delete_template', lang('Yes'), 'class="btn btn-danger"'); ?>
