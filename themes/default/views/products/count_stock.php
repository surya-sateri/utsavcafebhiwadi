...
<script>
function resetCountStock(){
	window.location='<?= site_url('products/count_stock'); ?>';
}
</script>
<style>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-12">
                            <div class="fprom-group">
                                ...
                                <button type="button" onclick="return resetCountStock();" class="btn btn-danger" id="reset"><?= lang('reset') ?></div>
                        </div>
                    </div>
                </div>
                <?php echo form_close(); ?>
