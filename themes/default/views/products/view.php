...
<?php if ($Owner || $Admin) { ?>
    <ul id="myTab" class="nav nav-tabs">
        ...
        <li class=""><a href="#challans" class="tab-grey"><?= lang('Challans') ?></a></li>
        ...
        <?php if ($product->type == 'standard') { ?>
            ...
            <li class="Qty_Adjustment_Class "><a href="#damages" class="tab-grey"><?= lang('Adjustments') ?></a></li>
            <?php if($Settings->product_batch_setting > 0) { ?>
            <li class=""><a href="#batches" class="tab-grey"><?= lang('Batches') ?><img src="<?= site_url('themes/default/assets/images/new.gif') ?>" height="15px" alt="new"></a></li>
            <?php } ?>
        <?php } ?>
    </ul>
